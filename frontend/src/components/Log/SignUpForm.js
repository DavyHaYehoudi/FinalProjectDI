   ...
   if(password !== controlPassword || !terms.checked){
    ...
    return (
        ...
        { formSubmit ? (
            ...
            <SignInForm />
            <span></span>
            <h4 className='success'>successful registration, please login</h4>
            </>
         ) : (
            <form action='' onSubmit= { handleRegister } id='sign-up-form'>
                ...
                <input 
                    ...
                    <label htmlFor='terms'>I accept the <a href='/' target='_blank' rel='noopener noreferrer'>terms and conditions</a> </label>
